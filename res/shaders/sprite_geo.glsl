...
void EmitQuad() {
  ...
  vec2 texel_bottom_left = vec2(gs_in[0].texel_top_left.x, gs_in[0].texel_bottom_right.y);
  vec2 texel_top_right = vec2(gs_in[0].texel_bottom_right.x, gs_in[0].texel_top_left.y);
